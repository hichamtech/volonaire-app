package com.example.volontaire_app.EspaceAdministrator;
...
public class ListPersonnneAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<Personne> dataModelArrayList;

    public ListPersonnneAdapter(Context context, ArrayList<Personne> dataModelArrayList) {
