...
public class EditVolentaireFormActivity extends AppCompatActivity {


    private static final String DEBUGTAG = EditVolentaireFormActivity.class.getCanonicalName();
    ...
    private void UpdateClient() {
      ...
      URL_BASE  = urLs.URL_BASE_PERSONNE+idClient;
            ...
            try {
                ...
                Log.d(DEBUGTAG,"Modifier CLIENT");
                ...
                JsonObjectRequest jsonOblect = new JsonObjectRequest(Request.Method.PUT, URL_BASE.trim(), jsonBody, new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        Intent intent = new Intent(EditVolentaireFormActivity.this, ListVolentaireActivity.class);
