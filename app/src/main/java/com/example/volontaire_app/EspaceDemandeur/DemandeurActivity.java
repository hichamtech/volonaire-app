package com.example.emploiandroid.EspaceDemandeur;
...
public class DemandeurActivity extends AppCompatActivity {
    private static final String DEBUGTAG = DemandeurActivity.class.getCanonicalName();
    ...
    private void openprofile() {
        Intent i = new Intent(DemandeurActivity.this,ProfileMonitorActivity.class);
        startActivity(i);
        setContentView(R.layout.activity_moniteur);
    }
}
